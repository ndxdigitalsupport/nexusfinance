...
def doc_hosting():
    ...
    doc.p("Six hosting providers are evaluated based on price, performance, and suitability "
    ...
    doc.table(
        ...
        [
            ...
            ["Twilio SMS", "$0.01", "Per OTP", "Shared across clients"],
    ...
    doc.table(
        ...
        [
            ...
            ["Most Flexible", "Railway", "Usage-based billing, pay only for what you use"],
        ],
