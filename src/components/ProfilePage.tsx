    ...
    <div className="animate-in fade-in duration-300 max-w-6xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="premium-card rounded-3xl overflow-hidden relative border border-[var(--border-primary)] transition-all duration-300 hover:shadow-2xl hover:border-[var(--accent)] group">
            ...
            <div className="p-8 relative pt-12 flex flex-col items-center text-center">
              ...
              {/* Detail list items */}
              <div className="w-full mt-8 pt-6 border-t border-[var(--border-primary)] space-y-4 text-left">
        ...
        {/* Right Column: Settings Forms (Personal Information & Password Update) */}
