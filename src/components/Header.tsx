        ...
        <div className="flex items-center gap-2 relative ml-auto">
          ...
          <div className="relative">
            ...
            {showNotificationsDropdown && (
              <div className="absolute right-0 mt-2 w-80 bg-[var(--surface-card)] border border-[var(--border-primary)] rounded-[20px] shadow-xl py-2 z-50 animate-dropdown-enter backdrop-blur-xl">
