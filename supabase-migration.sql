...
-- Generated by bcryptjs for server-side auth verification
INSERT INTO nexus_users (name, email, password, role, verified) VALUES
  ('Demo Customer', 'customer@nexus.com', '$2b$10$DkHFo7jnBGQHFwwqGLIy4.9o.YwvHQ5/JY2FwHxWRtnuTTvKionwS', 'customer', true),
  ('Demo Loan Officer', 'officer@nexus.com', '$2b$10$DkHFo7jnBGQHFwwqGLIy4.9o.YwvHQ5/JY2FwHxWRtnuTTvKionwS', 'loan-officer', true),
  ('Demo Admin', 'admin@nexus.com', '$2b$10$DkHFo7jnBGQHFwwqGLIy4.9o.YwvHQ5/JY2FwHxWRtnuTTvKionwS', 'super-admin', true);
